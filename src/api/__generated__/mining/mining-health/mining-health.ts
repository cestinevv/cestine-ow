...
export const getHealthQueryKey = () => {
  return [`/api/mining/health`] as const;
};
...
export type livenessResponse404 = {
  data: ResultObject;
  status: 404;
};
...
export const getLivenessUrl = () => {
  return `/api/mining/health/liveness`;
};
...
export const getLivenessQueryKey = () => {
  return [`/api/mining/health/liveness`] as const;
};
